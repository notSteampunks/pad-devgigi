    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <td>Seruni</td>
                <td>7 bulan</td>
                <td>Sudah <span class="text-muted">(19/02/2022)</i></td><td>
                <a href="{{route('dokter.rekapDetailUKGM')}}" class="btn btn-primary btn-icon-text btn-xs" role="button">
                    Lihat Rekap    
                    <i class="btn-icon-append" data-feather="book-open"></i>
                </a>
                <a class="btn btn-info btn-icon btn-xs" id="serun" href="#" role="button">
